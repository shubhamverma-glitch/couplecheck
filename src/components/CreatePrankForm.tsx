...
const CreatePrankForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("リンクの作成に失敗しました。もう一度お試しください。");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="card-romantic rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gradient">トラップを作成</h2>
            <HeartIcon size="md" animated />
          </div>

          <p className="text-center text-muted-foreground mb-8">
            名前を入力してリンクを作成しよう。友達に共有して、このトラップに引っかけちゃおう！ 💕
          </p>
