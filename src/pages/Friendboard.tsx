...
const questions = [
  { id: "kiss", text: "好きな人にキスしたことある？", emoji: "💋" },
  { id: "date", text: "好きな人とデートしたことある？", emoji: "🌹" },
  { id: "dream", text: "好きな人の夢を見る？", emoji: "💭" },
  { id: "stalk", text: "よくSNSをチェックする？", emoji: "📱" },
  { id: "jealous", text: "他の人と話してると嫉妬する？", emoji: "😤" },
  { id: "confess", text: "告白しようとしたことある？", emoji: "💌" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gradient mb-2">💖 フレンドボード 💖</h1>
            <p className="text-muted-foreground">トラップに引っかかった人を見てみよう！ 😏</p>
            {prank && (
              <p className="text-sm text-primary mt-2">
                作成者: <span className="font-bold">{prank.creator_name}</span>
              </p>
            )}
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-bold text-foreground">
                      {responses.length}人がトラップに引っかかりました！
                    </h2>
                  </div>
